...
const MAX_SUPPLY = 12; // The maximum number of NFTs that can be minted. CANNOT BE UPDATED!
...
const ROYALTY_ADDRESS = "0x97652b393712c2dF7f7a882eEE0854A5c8fa4448"; // Address that will receive the royalty
...
const GENERIC_DESCRIPTION = "Mystery sticker"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeihzheqzjfuhjlov52zjspo44urulygkj7jm25z4rfwxzlsrt2ghzq"; // Replace with your generic image that will display for all NFTs pre-reveal.
